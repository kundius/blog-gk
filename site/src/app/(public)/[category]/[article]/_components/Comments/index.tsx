...
import { CommentsForm, CommentsFormReply } from '../CommentsForm'
import { CommentsItem, CommentsItemData } from '../CommentsItem'
import { CommentsItemSkeleton } from '../CommentsItem/skeleton'
  ...
  return (
    <div className={styles.Wrapper} id="comments">
      ...
      <div
        className={cn(
          styles.Wall,
          'transition duration-300 dark:bg-gray-800'
        )}
      >
